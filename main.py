...
class SecurityCamera:
    ...
    def _trigger_anpr_for_vehicles(self, detections, frame):
        """Queue vehicle detections for ANPR processing"""
        ...
        for det in detections:
            if det['class'] in [2, 5, 7]:  # car, bus, truck
                try:
                    ...
                    break  # No point trying more if queue is full
            ...
            try:
                ...
                if self.use_hailo:
                    ...
                    for det in detections:
                        ...
                        # Only log to database if cooldown has passed for this class
                        if self._should_log_detection(cls):
                        ...
                        # Vehicle ANPR triggering still happens every frame
                        # (ANPR queue has its own size limit)
                    ...
                    for result in results:
                        ...
                        for box in boxes:
                            ...
                            # Build detection dict for frame buffer (always, for live view)
                            detections_list.append({
                                'class': cls,
                                'class_name': class_name,
                                'confidence': conf,
